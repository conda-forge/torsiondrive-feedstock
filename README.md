...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/torsiondrive-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6109&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/torsiondrive-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `torsiondrive` can be installed with:

```
conda install torsiondrive
```

It is possible to list all of the versions of `torsiondrive` available on your platform with:
